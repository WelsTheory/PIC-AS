# 1 "Programa_principal.s"
# 1 "<built-in>" 1
# 1 "Programa_principal.s" 2
...
; CONFIG1L
  ...
  CONFIG USBDIV = 1 ; USB Clock Selection bit (used in Full-Speed USB mode only; UCFG:((UCFG) and 0FFh), 2 = 1) (USB clock source comes directly from the primary oscillator block with no postscale)
...
; CONFIG ((RCON) and 0FFh), 0 = OFF ; Brown-out Reset Enable bits (Brown-out Reset disabled in hardware and software)
...
; CONFIG3H
  CONFIG CCP2MX = OFF ; ((PORTC) and 0FFh), 1 MUX bit (((PORTC) and 0FFh), 1 input/output is multiplexed with ((PORTB) and 0FFh), 3)
  CONFIG PBADEN = OFF ; PORTB A/D Enable bit (PORTB<4:0> pins are configured as digital I/O on Reset)
  CONFIG LPT1OSC = OFF ; Low-Power Timer 1 Oscillator Enable bit (Timer1 configured for higher power operation)
  CONFIG MCLRE = ON ; MCLR Pin Enable bit (MCLR pin enabled; ((PORTE) and 0FFh), 3 input pin disabled)
